...
#define APP_ICON_WIDTH						(42)
#define APP_ICON_HEIGHT						(42)
#define APP_ICON_ROW_BYTES					((APP_ICON_WIDTH + 7) / 8)
#define APP_ICON_SIZE						(APP_ICON_ROW_BYTES * APP_ICON_HEIGHT)
#define APP_UPDATE_META_MAGIC				0x41504D31u
