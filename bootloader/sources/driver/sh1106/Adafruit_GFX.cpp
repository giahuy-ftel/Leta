...
paired with a hardware-specific library.
*/
...
void Adafruit_GFX::drawMoon(int16_t x0, int16_t y0, int16_t r, uint16_t color) {
	int32_t tepm1, tepm2;
...
void Adafruit_GFX::drawSun(int16_t x0, int16_t y0, int16_t r, uint16_t color) {
	int16_t xr = x0 + r / 2;
	int16_t yr = y0 + r / 2;
