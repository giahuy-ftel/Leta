...
static void event_hdler(void * p_event)
{
    ...
    case SIG_BTN_DR_PRESSED:
		...
		screen_timeout_restart_configured();
			if(time_set.year != watch_time_now.year ||
			   time_set.month != watch_time_now.month ||
			   time_set.day != watch_time_now.day ||
			   time_set.hour != watch_time_now.hour ||
			   time_set.minute != watch_time_now.minute ||
			   time_set.second != watch_time_now.second)
		{
