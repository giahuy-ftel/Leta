...
#define OS_CFG_SYSTICK_CLOCK_HZ           ((uint32_t)72000000)
#define OS_CFG_HEAP_SIZE                  ((size_t)1024U * 5U) /**< Total static heap size in bytes for OS allocator. */
...
#define OS_CFG_USE_SHELL                  (0u) /**< Enable (`1`) or disable (`0`) the built-in AKOS shell thread. */
#define OS_CFG_SHELL_PROMPT_NAME          "akos:~$ "  /**< Prompt name for the shell. */
#endif

#define OS_CFG_USE_RUNTIME_STATS          (0u) /**< Enable (`1`) or disable (`0`) runtime statistics and CPU load calculation. */
...
#define OS_CFG_USE_LOG                    (0u) /**< Enable (`1`) or disable (`0`) logging helpers. */
#endif
